...
On the resulting screen, enter the local server IP Address in the form of a URL. URL will be what you open on browser to use planet. For example, if you use the vagrant in your laptop, you should use your laptop ip address http://192.168.0.110 in the form of a URL. Your ip address is different from these examples. Also, enter the Pin from Step 1 above
